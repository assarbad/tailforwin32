 ...
 * 
 * $Id: MainFrm.cpp,v 1.17 2004/07/30 07:35:33 paulperkins Exp $
 * 
 */
...
#define WM_OPEN_THIS_FILE   (WM_USER + 2)
...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
  ...
  ON_WM_CREATE()
	...
	//}}AFX_MSG_MAP
  ON_MESSAGE(WM_OPEN_THIS_FILE, OnOpenThisFile)
END_MESSAGE_MAP()
...
//  if (!strLastFile.IsEmpty () && theApp.m_bAutoLoad)
  ...
  { 
    // Bug #951860 - Add command-line processing. Thanks, mausoma!
    m_strFileToOpen = cmdInfo.m_strFileName;

    PostMessage (WM_OPEN_THIS_FILE);
  } 
...
LRESULT CMainFrame::OnOpenThisFile(WPARAM wParam, 
LPARAM lParam)
{
  if (m_strFileToOpen.IsEmpty ())
  {
    return 0;
  }

  m_Workspace.AddWorkspaceFile (m_strFileToOpen.GetBuffer(10), 
                                m_Workspace.m_pDefaultWorkspace);

  m_strFileToOpen.Empty();
