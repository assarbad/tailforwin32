 ...
 * 
 * $Id: HotListDisplay.cpp,v 1.9 2006/01/23 09:50:20 paulperkins Exp $
 * 
 */
  ...
  void)
{
  ...
  if (0 == m_List.m_HeaderCtrl.GetItemCount ())
  {
    ...
    int iPluginWidth = 50;
    int iActiveWidth = 20;
    int iFrigWidth = 20;    // Bug #1019400 - Resize keyword column to stop scrollbar obscuring Colour column.
