 ...
 * 
 * $Id: Tail.h,v 1.11 2003/12/01 08:24:23 paulperkins Exp $
 * 
 */
...
class CWorkspaceDlg;
class CMainFrame;
class CTailMultiDocTemplate;
class CWorkspaceMultiDocTemplate;
class CWorkspace;
...
public:
  ...
  CDocument* OpenDocumentFile (LPCTSTR lpszFileName, CWorkspace* pWksp);
...
//  CMultiDocTemplate* m_pDocTemplate;
  ...
  CWorkspaceMultiDocTemplate* m_pWksDocTemplate;
