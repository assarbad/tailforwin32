 ...
 * 
 * $Id: Settings.cpp,v 1.2 2004/04/07 18:08:48 paulperkins Exp $
 * 
 */
...
BOOL CSettings::Load (void)
{
  ...
  m_crFont              = theApp->GetProfileInt (_T("Settings"), _T("FontColour"),         RGB(0, 0, 0));
...
BOOL CSettings::Save (void)
{
  ...
  theApp->WriteProfileInt (_T("Settings"), _T("FontColour"), m_crFont);
...
// CSettings
//
COLORREF CSettings::GetFontColour (void) 
{ 
  return m_crFont;  
}
...
// CSettings
//
void CSettings::SetFontColour (COLORREF cr) 
{ 
  m_crFont = cr;  
}
